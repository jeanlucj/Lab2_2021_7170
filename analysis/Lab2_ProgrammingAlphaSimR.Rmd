...
2. AlphaSimR  
  i) AlphaSimR is a package to simulate breeding populations and tasks. It is not completely intuitive nor completely well-documented. We will want to use it ultimately to optimize breeding schemes. Hopefully, we will be able to contrast it's output with the output of deterministic analytic optimization  
...
addToREADME("The packages used in this script are:")
